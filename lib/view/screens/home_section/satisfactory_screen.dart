...
class SatisfactoryScreen extends StatefulWidget {
  const SatisfactoryScreen({Key? key}) : super(key: key);

  @override
  State<SatisfactoryScreen> createState() => _SatisfactoryScreenState();
}

class _SatisfactoryScreenState extends State<SatisfactoryScreen> {
      ...
      appBar:  AppBar(automaticallyImplyLeading: false,
        title: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            ...
            Text("Satisfactory",style:Constant.textTask,),
