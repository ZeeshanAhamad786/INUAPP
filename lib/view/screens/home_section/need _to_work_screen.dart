...
class NeedToWorkScreen extends StatefulWidget {
  const NeedToWorkScreen({Key? key}) : super(key: key);

  @override
  State<NeedToWorkScreen> createState() => _NeedToWorkScreenState();
}

class _NeedToWorkScreenState extends State<NeedToWorkScreen> {
      ...
      appBar:  AppBar(automaticallyImplyLeading: false,
        title: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            ...
            Text("Need to Work",style:Constant.textTask,),
